...
(function() {{
    ...
    // Try to write to parent document when possible (handles iframe top window), fallback to current document
    ...
    const setCookie = (name, value) => {{
        ...
        }} catch (e) {{ cookie += ' SameSite=Lax;'; }}
        try {{ parentDoc.cookie = cookie; }} catch (e) {{ try {{ document.cookie = cookie; }} catch (e) {{}} }}
    }};
